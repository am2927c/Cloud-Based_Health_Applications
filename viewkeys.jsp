...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html"><span class="style10">dentity-Based Encryption with Cloud Revocation Authority and Its Applications</span></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
			...
			<p align="center" class="style4 style8"><span class="style9"><%= (String)application.getAttribute("fullname")%></span> Uploaded File Keys</p>
				...
				%>
				 ...
				 <p align="center"><a href="ohome.jsp" class="style7">Home</a></p>
    </div>
  </div>
  <div class="fbg">
