...
<head>
<title>KULR: Key Updating for Leakage Resiliency</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize style4">
    	<div align="center" class="style5">Success</div>
    </div>
    <div align="center" class="style4">
      <p>&nbsp;</p>
      <p>
        <%
    	String otype = (String)application.getAttribute("category");
    	if(otype.equals("Owner")){
    		%>
